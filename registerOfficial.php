            ...
            <div class="container mt-5">
                <form name="officials" method="POST" action="./database/database.php" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input class="form-control form-control-lg" rows="3" type="text" id="pob" name="pob" placeholder="pob" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required>
